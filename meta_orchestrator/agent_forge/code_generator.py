...
class CodeGenerator:
    """
    Generates the source code for a new agent variant based on a design
    ...
    def generate_and_write_code(self, design_spec: Dict[str, Any], output_dir: str) -> str:
        """
        Generates the agent's source code and writes it to a new file.
        ...
        Args:
            ...
            output_dir: The base directory to write the new variant file to
                        (e.g., 'meta_orchestrator/experiment_hub/variants/').
